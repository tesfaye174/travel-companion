package com.example.travelcompanion.data.datasource
...
class LocalDataSource @Inject constructor(
    ...
    fun getTripsByType(type: String): Flow<List<TripEntity>> {
        return database.tripDao().getTripsByType(com.example.travelcompanion.domain.model.TripType.valueOf(type))
    }
