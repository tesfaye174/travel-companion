...
public final class TravelRepositoryImpl implements com.example.travelcompanion.domain.repository.TravelRepository {
    ...
    @java.lang.Override()
    @org.jetbrains.annotations.Nullable()
    public java.lang.Object updateJourney(@org.jetbrains.annotations.NotNull()
    com.example.travelcompanion.domain.model.Journey journey, @org.jetbrains.annotations.NotNull()
    kotlin.coroutines.Continuation<? super kotlin.Unit> $completion) {
        return null;
    }
    ...
    @java.lang.Override()
    @org.jetbrains.annotations.NotNull()
    public kotlinx.coroutines.flow.Flow<java.util.List<com.example.travelcompanion.domain.model.Note>> getNotesByTrip(long tripId) {
        return null;
    }
    
    @java.lang.Override()
    @org.jetbrains.annotations.NotNull()
    public kotlinx.coroutines.flow.Flow<java.util.List<com.example.travelcompanion.domain.model.Note>> getNotesByJourney(long journeyId) {
        return null;
    }
}